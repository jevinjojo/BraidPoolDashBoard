...
describe('TransactionsPage - Tailwind Tests', () => {
    ...
    describe('Transaction Categories Section', () => {
        ...
        it('displays category descriptions', () => {
            ...
            expect(screen.getByText(/Transactions in bitcoind mempool only/)).toBeInTheDocument();
            expect(screen.getByText(/Transactions committed to cmempool node/)).toBeInTheDocument();
            expect(screen.getByText(/Transactions proposed for next block/)).toBeInTheDocument();
        });
    });
    ...
    describe('Error Handling', () => {
        it('displays error message when fetch fails', async () => {
            mockFetchRecentTransactions.mockRejectedValueOnce(new Error('Network error'));
