...
describe("Transaction Types", () => {
  ...
  describe("TRANSACTION_CATEGORY_LABELS", () => {
    it("has labels for all categories", () => {
      ...
      expect(TRANSACTION_CATEGORY_LABELS[TransactionCategory.COMMITTED]).toBe(
        "Committed",
      );
      expect(TRANSACTION_CATEGORY_LABELS[TransactionCategory.PROPOSED]).toBe(
        "Proposed",
      );
      expect(TRANSACTION_CATEGORY_LABELS[TransactionCategory.SCHEDULED]).toBe(
        "Scheduled",
      );
      expect(TRANSACTION_CATEGORY_LABELS[TransactionCategory.CONFIRMED]).toBe(
        "Confirmed",
      );
      expect(TRANSACTION_CATEGORY_LABELS[TransactionCategory.REPLACED]).toBe(
        "Replaced",
      );
    });
  ...
  describe("TRANSACTION_CATEGORY_DESCRIPTIONS", () => {
    it("has descriptions for all categories", () => {
      ...
      expect(
        TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.COMMITTED],
      ).toBe("Transactions committed to cmempool node");
      expect(
        TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.PROPOSED],
      ).toBe("Transactions proposed for next block");
      expect(
        TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.SCHEDULED],
      ...
      expect(
        TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.REPLACED],
  ...
  describe("Type Interfaces", () => {
    ...
    it("TransactionOutput has correct structure", () => {
      ...
      expect(output.scriptpubkey_address).toBe(
